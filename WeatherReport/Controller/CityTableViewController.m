...
//    self.edgesForExtendedLayout = UIRectEdgeAll;
    ...
    UIVisualEffectView *visualView = [[UIVisualEffectView alloc] initWithFrame:[UIScreen mainScreen].bounds];
...
//    [self.view addSubview:imageView];
    ...
    UIBarButtonItem *turnbackItem = [[UIBarButtonItem alloc] initWithTitle:@"返回" style:UIBarButtonItemStyleDone target:self action:@selector(turnToVC:)];
    turnbackItem.tintColor = [UIColor whiteColor];
    self.navigationItem.leftBarButtonItem = turnbackItem;
    self.navigationItem.rightBarButtonItem.tintColor = [UIColor whiteColor];
    self.navigationItem.rightBarButtonItems[1].tintColor = [UIColor whiteColor];
...
- (void)turnToVC:(UIBarButtonItem *)item {
...
//    cell.backgroundColor = [UIColor colorWithRed:255.0 / 256 green:245.0 / 256 blue:247.0 / 256 alpha:0.5];
